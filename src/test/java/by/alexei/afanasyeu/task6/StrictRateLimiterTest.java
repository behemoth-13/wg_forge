...
public class StrictRateLimiterTest extends JerseyTest {
    ...
    protected ResourceConfig configure() {
        ...
        RateLimitingFilterStrictStrategy.setLimitParams(6, 1_000L);
        return new ResourceConfig(PingController.class, RateLimitingFilterStrictStrategy.class);
    }
    ...
    public void testOneThread() throws InterruptedException {
        ...
        Assert.assertTrue(rejected > 50*0.3 && rejected < 50*0.5);
    }
}
